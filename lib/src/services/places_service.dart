...
class PlacesService {
  final key = 'AIzaSyC5Boj4dIR3QYo4ezPgwFZVDsMHDaRVR28';

  Future<List<PlaceSearch>> getAutocomplete(String search) async {
    var url =
        'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$search&types=address&key=$key&language=en';
